...
const cityIntroFacts = {
  malaga: [
    "Málaga is de geboortestad van Pablo Picasso; zijn geboortehuis aan de Plaza de la Merced is nu een museum.",
    "De stad werd rond 770 v.Chr. gesticht door de Feniciërs en is daarmee een van de oudste nog bewoonde steden van Europa.",
    "Málaga geldt als de hoofdstad van de Costa del Sol, met naar schatting meer dan 300 zonnige dagen per jaar.",
  ],
  dusseldorf: [
    'De oude binnenstad van Düsseldorf staat bekend als "die längste Theke der Welt" (de langste bar ter wereld), vanwege de enorme concentratie kroegen op een klein oppervlak.',
    'De Königsallee ("Kö") geldt als een van de meest exclusieve winkelstraten van Europa, en Düsseldorf wordt vaak de modehoofdstad van Duitsland genoemd.',
    "Dichter Heinrich Heine werd hier geboren; zijn standbeeld en een universiteit in de stad dragen zijn naam.",
  ],
  keulen: [
    "De Kölner Dom deed er meer dan 600 jaar over om afgebouwd te worden (begonnen in 1248, voltooid in 1880).",
    'De parfum "eau de Cologne" is hier ontstaan en dankt er zijn naam aan.',
    'Keulen is een van de oudste steden van Duitsland, gesticht door de Romeinen als "Colonia" - vandaar ook de huidige naam.',
  ],
  frankfurt: [
    "Schrijver Johann Wolfgang von Goethe werd hier geboren; zijn geboortehuis is nog te bezoeken.",
    'Door zijn opvallende wolkenkrabberskyline (uniek voor Duitsland) wordt Frankfurt ook wel "Mainhattan" genoemd.',
    "De stad huisvest de Europese Centrale Bank en een van de oudste effectenbeurzen van Duitsland.",
  ],
  london: [
    'De stad werd door de Romeinen gesticht als "Londinium", bijna 2000 jaar geleden.',
    "De Londense metro (the Underground) was in 1863 het allereerste ondergrondse spoorwegnetwerk ter wereld.",
    "In Londen worden naar schatting meer dan 300 talen gesproken, wat het een van de meest diverse steden ter wereld maakt.",
  ],
  copenhagen: [
    "Tivoli Gardens, geopend in 1843, is een van de oudste nog bestaande pretparken ter wereld en zou Walt Disney hebben geïnspireerd voor Disneyland.",
    "Kopenhagen staat bekend als een van de meest fietsvriendelijke steden ter wereld, met meer fietsen dan auto's in het centrum.",
    "Het standbeeld De Kleine Zeemeermin, geïnspireerd op het sprookje van Hans Christian Andersen, staat al sinds 1913 aan de haven.",
  ],
  innsbruck: [
    "Innsbruck organiseerde twee keer de Olympische Winterspelen (1964 en 1976).",
    "Vanuit het centrum breng je met de kabelbaan (Nordkettenbahn) binnen enkele minuten naar de bergen van de Nordkette.",
    'Het bekende "Gouden Dakje" (Goldenes Dachl) - een balkon met 2657 vergulde koperen tegels - was ooit een koninklijke loge om stadsevenementen te bekijken.',
  ],
  vienna: [
    "Wenen geldt als de bakermat van de wals en was thuisbasis van componisten als Mozart, Beethoven en Johann Strauss.",
    "De Weense koffiehuiscultuur staat sinds 2011 op de UNESCO-lijst van immaterieel cultureel erfgoed.",
    "Wenen wordt in internationale ranglijsten regelmatig uitgeroepen tot een van de meest leefbare steden ter wereld.",
  ],
  madrid: [
    "Madrid is met ongeveer 650 meter boven zeeniveau de hoogst gelegen hoofdstad van de Europese Unie.",
    "Het Prado-museum in Madrid geldt als een van de belangrijkste kunstmusea ter wereld, met meesterwerken van Velázquez en Goya.",
    'Op de Puerta del Sol ligt "Kilometer 0", het officiële startpunt van waaruit alle Spaanse hoofdwegen worden gemeten.',
  ],
  valencia: [
    "Valencia geldt als de geboorteplaats van paella, oorspronkelijk een gerecht van rijstboeren uit de omliggende Albufera.",
    "De futuristische Stad van Kunsten en Wetenschappen (Ciutat de les Arts i les Ciències) werd gebouwd in de drooggelegde, omgeleide rivierbedding van de Turia.",
    "Tijdens het jaarlijkse Las Fallas-festival (UNESCO-erfgoed) worden reusachtige kunstwerken van papier-maché door de hele stad verbrand.",
  ],
  palma: [
    "Componist Chopin en schrijfster George Sand brachten in 1838-1839 een beroemde (en beruchte) winter door op Mallorca, wat Chopin inspireerde tot enkele van zijn bekendste werken.",
    "Kathedraal La Seu is een van de weinige kathedralen ter wereld die praktisch direct aan zee gebouwd is.",
    "Palma is de hoofdstad van de Balearen en werd achtereenvolgens door Romeinen, Vandalen, Moren en Aragonezen bestuurd.",
  ],
  douglas: [
    "Douglas is start- en finishplaats van de legendarische Isle of Man TT, een van de gevaarlijkste motorraces ter wereld.",
    "In Douglas rijdt sinds 1876 de oudste nog operationele paardentram ter wereld.",
    "Op het eiland Man geldt op veel plattelandswegen buiten de bebouwde kom geen snelheidslimiet.",
  ],
  paris: [
    "Parijs begon als een Romeinse nederzetting genaamd Lutetia, gesticht door een Keltische stam op een eiland in de Seine.",
    "De Eiffeltoren was oorspronkelijk bedoeld als tijdelijke constructie voor de Wereldtentoonstelling van 1889 en zou daarna weer worden afgebroken.",
    'Parijs kreeg de bijnaam "de Stad van het Licht" mede dankzij zijn vroege invoering van straatverlichting in de 19e eeuw.',
  ],
  rome: [
    "Volgens de legende werd Rome in 753 v.Chr. gesticht door Romulus, na een ruzie met zijn tweelingbroer Remus.",
    "Binnen Rome ligt Vaticaanstad, met minder dan een halve vierkante kilometer de kleinste soevereine staat ter wereld.",
    'Rome wordt vaak "de Eeuwige Stad" genoemd, een bijnaam die al door de oude Romeinen zelf werd gebruikt.',
  ],
  amsterdam: [
    "Amsterdam telt meer fietsen dan inwoners.",
    "De grachtengordel bestaat uit meer dan honderd kilometer aan grachten en wordt regelmatig vergeleken met (en soms zelfs groter genoemd dan) die van Venetië.",
    "Door de drassige ondergrond staat een groot deel van de historische binnenstad letterlijk op houten heipalen.",
  ],
  berlin: [
    "Berlijn was van 1961 tot 1989 letterlijk in tweeën gedeeld door de Berlijnse Muur.",
    "De stad heeft meer bruggen dan Venetië - naar schatting rond de 950.",
    "Berlijn telt meer dan 170 musea, een van de hoogste dichtheden aan musea per inwoner ter wereld.",
  ],
  lisbon: [
    "Net als Rome is Lissabon gebouwd op zeven heuvels.",
    "Volgens de overlevering is Lissabon een van de oudste steden van West-Europa, met een geschiedenis die zelfs verder terug zou gaan dan die van Rome.",
    "Een verwoestende aardbeving en tsunami in 1755 vernietigden een groot deel van de stad en hervormden letterlijk het aanzicht van het huidige centrum.",
  ],
  budapest: [
    "Boedapest ontstond in 1873 uit de samenvoeging van twee aparte steden aan weerszijden van de Donau: Buda en Pest.",
    "De stad heeft het grootste thermaalbadcomplex van Europa.",
    "Het Hongaarse Parlementsgebouw was bij voltooiing in 1904 het grootste parlementsgebouw ter wereld.",
  ],
  venice: [
    "Venetië is gebouwd op 118 kleine eilandjes, verbonden door zo'n 400 bruggen.",
    "Er rijdt geen enkele auto in het historische centrum - al het vervoer gaat te voet of per boot.",
    "De stad zakt langzaam weg en heeft daarnaast te kampen met stijgende zeespiegels, wat regelmatig tot overstromingen (acqua alta) leidt.",
  ],
  barcelona: [
    "Aan Gaudí's Sagrada Familia wordt sinds 1882 gebouwd, en de kerk is nog altijd niet volledig af.",
    "De Olympische Spelen van 1992 zorgden voor een complete transformatie van de Barcelonese kustlijn.",
    "Barcelona is de hoofdstad van Catalonië, een regio met een eigen taal (Catalaans) naast het Spaans.",
  ],
  prague: [
    'Praag wordt vaak "de Stad van de Honderd Torens" genoemd.',
    "De Karelsuniversiteit, opgericht in 1348, is een van de oudste universiteiten van Centraal-Europa.",
    "Het historische centrum van Praag is een van de grootste aaneengesloten UNESCO-werelderfgoedgebieden van Europa.",
  ],
  munich: [
    "München organiseert jaarlijks het Oktoberfest, 's werelds grootste bierfeest.",
    "De stad was gastheer van de Olympische Zomerspelen van 1972.",
    "München is de hoofdstad van Beieren en huisvest onder meer autofabrikant BMW.",
  ],
  milan: [
    "Milaan geldt als de mode- en designhoofdstad van Italië, met jaarlijkse modeweken die wereldwijd invloed hebben.",
    "Leonardo da Vinci's beroemde fresco Het Laatste Avondmaal bevindt zich in het klooster Santa Maria delle Grazie in Milaan.",
    "De bouw van de Dom van Milaan duurde bijna zes eeuwen, van 1386 tot in de 19e eeuw.",
  ],
  athens: [
    "Athene is een van de oudste steden ter wereld en is al meer dan 3000 jaar onafgebroken bewoond.",
    "De stad geldt als de bakermat van de democratie, ontstaan in het Athene van de 5e eeuw v.Chr.",
    "De Akropolis, met de Parthenon als middelpunt, domineert al eeuwenlang de skyline van de stad.",
  ],
  edinburgh: [
    "Edinburgh organiseert jaarlijks het Fringe Festival, 's werelds grootste kunstenfestival.",
    "Delen van de stad, zoals Arthur's Seat, liggen op uitgedoofde vulkanen.",
    "J.K. Rowling schreef een deel van de Harry Potter-boeken in cafés in Edinburgh, wat de stad tot een populaire bestemming voor fans maakt.",
  ],
};
